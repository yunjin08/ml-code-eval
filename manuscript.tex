...
\addplot[thick, blue!70!black] table[x=beta, y=f1, col sep=comma] {\PacSensGainOneTable};
...
\addplot[thick, green!50!black] table[x=beta, y=delta_auc, col sep=comma] {\PacSensGainOneTable};
